...
public class EarthQuakeQuery {
         ...
         */
        public EarthQuakeQuery(String JSONResponse) {
             ...
             */
            public ArrayList<earthquakes> extractEarthquakes () {

                // Create an empty ArrayList that we can start adding earthquakes to
                ArrayList<earthquakes> Earthquakes = new ArrayList<>();
                Log.e("EarthQuakeQuery.class", "********DADDY********");
                ...
                try {
                    ...
                    for (int i = 0; i <featureArray.length(); i++) {
                        Log.e("EarthQuakeQuery.class", "********     IN FOR LOOP      ********");
                        featureObject = featureArray.getJSONObject(i);
                        propertiesObject = featureObject.getJSONObject("properties");
                        magnitude = (float) propertiesObject.optDouble("mag");
                        location = propertiesObject.optString("place");
                        time = propertiesObject.optLong("time");
                        Earthquakes.add(new earthquakes(location, magnitude, time));
